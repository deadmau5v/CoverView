    ...
    return (
        <div className="">
            ...
            <div className="">
				...
				<a href="https://github.com/deadmau5v/CoverView" target="_blank" rel="noreferrer" className="hover:translate-x-2 flex items-center justify-center duration-300 bg-gray-700 group rounded-xl   text-white  ml-auto mr-4 font-Inter font-semibold ">
					<span className="md:text-sm text-xs px-2 md:px-4 py-1 md:py-2">⭐ 在 GitHub 上加星</span>
				</a>
			</div>
            ...
            <div className="md:mt-32  my-t0 mx-auto">
				...
				<div className="w-full text-center mx-auto p-10 md:p-4 ">
					<h2 className="md:text-5xl md:w-9/12 mx-auto text-3xl px-4 font-bold font-Anek text-gray-700">为什么封面图片比你想的更重要？</h2>
					...
					<p className="md:text-2xl text-xl md:text-left text-center font-Nunito ">每天大约有<span className="font-bold">700 万</span>篇博客文章发布，随着新一代写作工具的兴起，这个数字只会继续增长。</p>
                        </div>
				...
				<p className="md:text-2xl text-xl md:text-left text-center font-Nunito ">优质的封面图比随便挑选的图库图片能带来<span className="font-bold">更高的转化率</span>。</p>
                        </div>
                ...
                <h2 className="md:text-5xl text-3xl md:w-7/12 md:mx-auto mt-12 md:mt-32 mx-10 font-bold font-Anek text-center text-gray-700">使用 coverview，你可以在<span className="text-indigo-400">短短几秒</span>内制作封面图</h2>
                ...
                <div className="md:w-8/12 md:my-16 p-4 flex md:flex-row flex-col gap-4 mx-auto">
                    ...
                    <div className="md:w-1/2 md:border border-gray-50 md:shadow-sm md:shadow-gray-50 rounded-xl px-4 pt-6 flex flex-col md:mx-10">
                        ...
                        <div className="text-center">
                            <div className="text-xl w-max mx-auto text-white py-1 px-4 font-Anek font-semibold bg-indigo-400  rounded-full ">步骤 1</div>

                            <p className="md:text-3xl text-2xl p-4 text-center mx-auto my-2 font-semibold font-Inter text-gray-700">填写博客标题与作者名称</p>
                        </div>
                    ...
                    <div className="md:w-1/2 md:border  md:border-gray-50 md:shadow-sm md:shadow-gray-50 rounded-xl px-4 pt-6 flex flex-col md:mx-10">
                        ...
                        <div className="text-center">
                            <div className="text-xl w-max mx-auto text-white py-1 px-4 font-Anek font-semibold bg-indigo-400  rounded-full ">步骤 2</div>

                            <p className="md:text-3xl text-2xl p-4  text-center mx-auto my-2 font-semibold font-Inter text-gray-700">使用颜色、字体与图标自定义样式</p>
                        </div>
                ...
                <div className="md:w-7/12 p-6 mx-auto   rounded-xl md:border  md:border-gray-50 md:shadow-sm md:shadow-gray-50  flex md:flex-row flex-col justify-center items-center ">
                    ...
                    <div className="text-center md:w-1/2 m-4">
                        <div className="text-xl w-max mx-auto text-white py-1 px-4 font-Anek font-semibold bg-indigo-400  rounded-full ">步骤 3</div>
                        <p className="md:text-3xl mt-4 text-2xl pb-2  text-center mx-auto my-2 font-semibold font-Inter text-gray-700">从不同主题中选择你的风格</p>

                        <p className="md:text-xl text-gray-500 text-lg">Unsplash 集成、自定义图标，打造你的个人品牌。</p>
                    </div>
                ...
                <div className="bg-gray-800  text-white p-2">
                    <div className="md:w-8/12 mx-auto pt-32 p-6">
                        <h2 className="md:text-6xl text-4xl text-center font-Anek font-bold  mx-auto">简单、快速、易上手</h2>
                        <p className="md:text-2xl text-lg font-Inter text-gray-300 text-center py-4 md:w-8/12 mx-auto">专注写作，不再为封面图片烦恼。</p>
                        <Link to="/editor" >
                            <button className="flex mx-auto my-4 hover:translate-x-2 duration-300 bg-indigo-500 hover:bg-indigo-600  rounded-full  text-white md:text-xl text-base font-Nunito font-semibold p-4 px-8">免费体验，立即开始 &rarr;</button>
                        </Link>
                    </div>
                    ...
                    <footer className=" p-10 gap-2 flex md:flex-row flex-col-reverse font-Inter md:px-20 md:justify-between justify-center mx-auto md:w-10/12 w-full items-center">
                        ...
                        <div className=" flex flex-col">
                            <span className="md:text-lg text-sm">由 <a href="https://github.com/deadmau5v" className="font-semibold underline decoration-wavy underline-offset-4" target="_blank" rel="noreferrer">deadmau5v</a> 和 <a href="https://rutik.dev" className="font-semibold underline decoration-wavy underline-offset-4" target="_blank" rel="noreferrer">Rutik Wankhade</a> 合作打造 💛</span>
                        </div>

                        <div className="md:text-lg text-sm flex flex-wrap gap-4 ">
                            <Link to="/faq" className="hover:underline">使用指南</Link>
                            <a href="https://github.com/deadmau5v/CoverView" target="_blank" rel="noreferrer" className="hover:underline">GitHub</a>
                        </div>
